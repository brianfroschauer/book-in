...
public class AuthorSignupControllerTest {
    ...
    public void givenValidAuthor_whenSignup_thenReturnOkResponse() throws Exception {
        ...
        MockMultipartFile author = new MockMultipartFile("author", "", "application/json", objectMapper.writeValueAsString(signupAuthorDTO).getBytes());

        mockMvc
                .perform(MockMvcRequestBuilders.multipart("/authors/signup")
                        .file(author))
