...
//
//        final Author author = authorService.save(new Author());
//
//        assertNotNull(author);
...
//                .save(any(Author.class));
//
//        final Author author = authorService.update(4L, new Author());
//
//        assertNotNull(author);
//        verify(authorRepository).findById(4L);
//        verify(authorRepository).save(any(Author.class));
...
//                .findById(4L);
//
//        assertThrows(NotFoundException.class, () -> authorService.update(4L, new Author()));
//        verify(authorRepository).findById(4L);
